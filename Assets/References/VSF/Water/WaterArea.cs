...
using UnityEditor;
    ...
    public class WaterArea : MonoBehaviour
    {
        ...
        public float surfaceLevelCorector = 0.94f;
        ...
        m_BuoyancyEffector.surfaceLevel = size.y * 0.5f - surfaceLevelCorector;
        }
    ...
    public class WaterAreaEditor : Editor
    {
        ...
        m_WaterArea.surfaceLevelCorector =
               EditorGUILayout.FloatField("Surface corrector", m_WaterArea.surfaceLevelCorector);
