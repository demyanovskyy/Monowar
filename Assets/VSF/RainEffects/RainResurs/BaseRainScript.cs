...
namespace DigitalRuby.RainMaker
{
    public class BaseRainScript : MonoBehaviour
    {
        ...
        protected virtual void Start()
        {
            ...
            audioSourceRainLight = new LoopingAudioSource(this, RainSoundLight, audioMixergr);
            audioSourceRainMedium = new LoopingAudioSource(this, RainSoundMedium, audioMixergr);
            audioSourceRainHeavy = new LoopingAudioSource(this, RainSoundHeavy, audioMixergr);
            audioSourceWind = new LoopingAudioSource(this, WindSound, audioMixergr);
    ...
    public class LoopingAudioSource
    {
        ...
        public LoopingAudioSource(MonoBehaviour script, AudioClip clip, AudioMixerGroup audioMgr)
        {
            ...
            AudioSource.Stop();
            AudioSource.outputAudioMixerGroup = audioMgr;
            TargetVolume = 1.0f;
